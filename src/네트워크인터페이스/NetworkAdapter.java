...
// 모든 메소드는 자동으로 추상 메소드가 됨 (abstract 가 자동으로 붙음)
// 디폴트 메소드 : 예외적으로 구현부를 가지면, 상속 받은 클래스에서 재정의해서 사용 가능
// 정적메소드 객체와 상관없이 인터페이스 타입으로 사용 가능
public interface NetworkAdapter {
    void connect(); // 자동으로 abstract 와 public 이 붙음
}
// implements는 인터페이스를 상속 받는 예약어
class WiFi implements NetworkAdapter {
    ...
    @Override
    public void connect() {
        System.out.print(company + "WiFi에 연결 되었습니다.");
    }
}
