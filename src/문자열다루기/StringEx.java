...
public class StringEx {
    public static void main(String[] args) {
        ...
        String b = "java";
        String c = "hello";
//        System.out.println(a.equals(b)); // a 문자열과 b 문자열을 비교 결과 같으면 true
//        System.out.println(a.equals(c));
//        System.out.println(a.equalsIgnoreCase("HELLO")); //대소문자 구분하지 않음
//        System.out.println(a == c);

        //indexOf() :  문자열에서 특정 문자/문자열이 시작되는 인덱스를 리턴(반환) (인덱스는 0부터 시작)
        ...
        //replace(), replaceAll() : 문자열에서 특정 문자열을 다른 문자열로 대체할때 사용
        System.out.println(str.replaceAll("Java", ""));

        // substring() : 문자열에서 측정 문자를 추출 할 때 사용(시작 인덱스 부터 끝까지)
