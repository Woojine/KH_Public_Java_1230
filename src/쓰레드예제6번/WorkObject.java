package 쓰레드예제6번;
// 세마포어 : 여러개의 프로세서가 공통의 메모리 영역(Critical section)에 접근 하는 것을 방지
// 뮤텍스 : 여러개의 쓰레드이 공통의 메모리 영역에 접근하는 것을 방지 하는 것(자바에서는 synchronized)
public class WorkObject {
    // methodA() 동기화 처리가 되어서 동시 접근 허용을 하지 않음
