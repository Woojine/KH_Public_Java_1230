...
// 객체를 출력하기 위해서는 일렬로 연속적인 바이트로 변경해야 하는데, 이것을 직렬화(Serialization)하고 한다
// 반대로 파일이나 네트워크로 부터 전송된 객체를 읽을 수도 있는데, 이때 연속적인 바이트를 객체로 복원하는 역직렬화라고 한다
public class ObjectStreamEx {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        for(Board e : list) {
            ...
            System.out.println("내용 : " + e.getWriter());
    ...
    static void writeList() throws IOException {
        ...
        list.add(new Board(3,"제벌집 막내아들", "경제 드라마", "정대윤", new Date()));
